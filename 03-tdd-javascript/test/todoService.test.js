...
describe('todoService', () => {
    ...
    describe('#list', () => {
        const mockDatabase = [
            {
                name: 'XuxadaSilva',
                age: 90,
                meta: { revision: 0, created: 1611576376909, version: 0 },
                '$loki': 1
            },
        ]
        ...
        beforeEach(() => {
            ...
            todoService = new TodoService(depencies)
        })
    ...
    describe('#create', () => {
        ...
        it('should\'t save item with invalid data', () => {
            const data = new Todo({
                text: '',
                when: ''
            })
        ...
        it('should save item with late status when the property is further than today', () => {
            const properties = {
