...
describe('Pagination tests', () => {
    ...
    describe('#Pagination', () => {
        ...
        describe('#handleRequest', () => {
            it('should retry an request twice before thoing an exception and validade request paramas and flow', async () => {
            ...
            it('should return data form request when succeded', async () => {
        ...
        describe('#getPaginated', () => {
            ...
            it('should update request id on each request', async () => {
                ...
                // Array.from(pagination.getPaginated()) => this way does'nt wait on-demand data
                // It'll store all on memory and only after put on array 

                // const r = pagination.getPaginated()
                // r.next() => { done: true | false, value: {} }

                // The best way is to use for of
            ...
            it('should stop requesting when request return an empty array', async () => {
                const expectedThreshhold = 20
                const pagination = new Pagination()
                pagination.threshold = expectedThreshhold
                ...
                assert.ok(Pagination.sleep.calledWithExactly(expectedThreshhold))
            })
        })
    })
})